...
class modifier_med extends StatefulWidget {
  ...
  @override
  State<modifier_med> createState() => _modifier_medState();
}

class _modifier_medState extends State<modifier_med> {
            ...
            child: Container(
              child: Column(children: [
                ...
                Container(
                  ...
                  child: TextFormField(
                    initialValue: widget.eventDataList['nomMed'],
                ...
                Container(
                  ...
                  child: FormBuilderDropdown(
                    ...
                    initialValue: widget.eventDataList['formeMed'],
                  ),
                ),
                SizedBox(height: 15),
                Container(
                ...
                Container(
                    ...
                    child: FormBuilderDropdown(
                      ...
                      initialValue: widget.eventDataList['voieMed'],
                    )),
                SizedBox(height: 15),
                Container(
                  child: Text(
            ...
            onChanged: (int? value) {
              setState(() {
                selectedMinute = value;
                    ...
                    Text(
                      "${widget.eventDataList['formeMed']}(s)",
                      style:
